...
%
\item<6-> We want to compare the performance of \textcolor{red}{six different algorithm setups}\uncover<7->{:%
\begin{enumerate}%
...
%
\item<8-> As benchmark, we use 100 instances from \satLib\expandafter\scitep{\satLibReferences} with \textcolor{red}{different values of \maxSatVariables} (and \maxSatClauses)%
%
\end{itemize}%
%
