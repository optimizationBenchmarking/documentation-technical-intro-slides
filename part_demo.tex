...
\item<9-> 2-flip Hill Climber with Restarts%
\item<10-> $m$-flip Hill Climber\only<6>{, $m$ chosen randomly according to geometric distribution}%
\item<10-> $m$-flip Hill Climber with Restarts%
\end{enumerate}%
}%
%
\item<11-> As benchmark, we use 100 instances from \satLib\expandafter\scitep{\satLibReferences} with different values of \maxSatVariables\ and \maxSatClauses%
%
\end{itemize}%
%
